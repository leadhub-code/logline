...
This is an exact copy of the agent's framing module. The two packages are
independent and separately installable, and the agent must stay stdlib-only
(it runs on older Debian without a venv), so this small amount of shared
framing logic is duplicated rather than factored into a third package.
'''
